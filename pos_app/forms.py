...
class CustomUserForm(UserCreationForm):
    first_name = forms.CharField(widget=forms.TextInput({'class': 'form-control form-control-lg', 'autocomplete': 'off', 'placeholder': 'First Name'}))
    last_name = forms.CharField(
        widget=forms.TextInput({'class': 'form-control form-control-lg', 'autocomplete': 'off', 'placeholder': 'Last Name'}))
    username = forms.CharField(
        widget=forms.TextInput({'class': 'form-control form-control-lg', 'autocomplete': 'off', 'placeholder': 'Username'}))
    email = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control form-control-lg', 'placeholder': 'Email'}))
    phone_number = forms.CharField(widget=forms.NumberInput(attrs={'class': 'form-control form-control-lg', 'placeholder': 'Phone Number'}))
    role = forms.ChoiceField(widget=forms.Select({'class': 'form-control form-control-lg', 'placeholder': 'Role'}), choices=(('Admin', 'Admin'), ('Sales Personnel', 'Sales Personnel')))
